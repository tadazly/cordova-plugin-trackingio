...
//
#define REYUN_TRACKING_VERSION @"1.9.14"
...
/// @param customParams 自定义install参数
...
+ (void)initWithAppKey:(NSString *)appKey withChannelId:(NSString *)channelId withCAID:(nullable NSString *)caid
 withCAID2:(nullable NSString *)caid2 withMobDNAOid:(nullable NSString *)oid withParams:(nullable NSDictionary *)customParams withStartupParams:(nullable NSDictionary *)startupParams;
//注册成功后调用
